...
| proxyConfiguration | object | Proxy settings of the run and the proxy is required. This actor works better with the Apify proxy group SHADER or RESIDENTIAL. If not, you can use other Apify proxy groups | `{ "useApifyProxy": true }`|
